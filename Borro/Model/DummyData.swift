...
struct DummyData{
    ...
    static let items = [Item(itemID: "XXX", sellerID: "XXX", title: "Cannon DSL 3600",categories: ["Technology and Gadgets"], condition: "Good Condition", dailyPrice: 29, description: "Great Camera, Great Condition, contact me to borrow the camera, I’m available most week days for picks ups and drop offs", quantity: 1, pickUpLocation: "26 Watermint Quay, Craven Walk", images: []),Item(itemID: "XBX", sellerID: "AXX", title: "Cannon Lightweight 500",categories: ["Technology and Gadgets"], condition: "Good Condition", dailyPrice: 20, description: "New camera given to me as a present",quantity: 0, pickUpLocation: "34 Judd Street", images: [])]
